...
对于 C/S 架构的 tRPC 框架来说，其处理请求和回复的过程中，插件的调用流程如下图所示：

![tRPC 插件流程图](https://git.woa.com/trpc-go/trpc-go/raw/master/.resources/developer_guide/develop_plugins/protocol/tRPC_Plugin_Flowchart.png)
...
可见 trpc-go/trpc-codec 及 trpc-go/trpc-database。
...
![服务端协议插件流程图](https://git.woa.com/trpc-go/trpc-go/raw/master/.resources/developer_guide/develop_plugins/protocol/Server-side_Protocol_Plugin_Flowchart.png)
...
![客户端协议插件流程图](https://git.woa.com/trpc-go/trpc-go/raw/master/.resources/developer_guide/develop_plugins/protocol/Client-side_Protocol_Plugin_Flowchart.png)
