...
对于服务端，必须要配置框架配置中“global”，“server”两部分的配置，配置参数的具体含义，取值范围等信息请参考 [框架配置](https://git.woa.com/trpc-go/trpc-wiki/blob/main/user_guide/framework_conf_zh_cn.md) 文档。“plugins”部分的配置取决于所选的插件，具体参考下面的【7 插件选择】章节。
