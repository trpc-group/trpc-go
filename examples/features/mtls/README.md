...
In order for the server to support mTLS authentication, please configure `NewServer` with the ServerOption `server.WithTLS()`, or use the server configuration `trpc_go.yaml`.
