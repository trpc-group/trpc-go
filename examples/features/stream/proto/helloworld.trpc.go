...
type TestStreamService interface {
	UnaryCall(ctx context.Context, req *HelloReq) (*HelloRsp, error)
	...
	// BidirectionalStream Defined Bidirectional streaming RPC
	//  Add stream in front of HelloReq and HelloRsp
	BidirectionalStream(TestStream_BidirectionalStreamServer) error
}

func TestStreamService_UnaryCall_Handler(svr interface{}, ctx context.Context, f server.FilterFunc) (interface{}, error) {
	req := &HelloReq{}
	filters, err := f(req)
	if err != nil {
		return nil, err
	...
	handleFunc := func(ctx context.Context, reqbody interface{}) (interface{}, error) {
		return svr.(TestStreamService).UnaryCall(ctx, reqbody.(*HelloReq))
	}
...
var TestStreamServer_ServiceDesc = server.ServiceDesc{
	...
	Methods: []server.Method{
		{
			Name: "/trpc.examples.stream.TestStream/UnaryCall",
			Func: TestStreamService_UnaryCall_Handler,
		},
	},
...
func (s *UnimplementedTestStream) UnaryCall(ctx context.Context, req *HelloReq) (*HelloRsp, error) {
	return nil, errors.New("rpc UnaryCall of service TestStream is not implemented")
}
...
type TestStreamClientProxy interface {
	UnaryCall(ctx context.Context, req *HelloReq, opts ...client.Option) (rsp *HelloRsp, err error)
	// ClientStream Defined Client-side streaming RPC
	//  Add stream in front of HelloReq
...
func (c *TestStreamClientProxyImpl) UnaryCall(ctx context.Context, req *HelloReq, opts ...client.Option) (*HelloRsp, error) {
	ctx, msg := codec.WithCloneMessage(ctx)
	defer codec.PutBackMessage(msg)
	msg.WithClientRPCName("/trpc.examples.stream.TestStream/UnaryCall")
