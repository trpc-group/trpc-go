...
func (m *MockGreeterService) SayHi(ctx context.Context, req *HelloRequest) (*HelloReply, error) {
	m.ctrl.T.Helper()
...
func (mr *MockGreeterServiceMockRecorder) SayHi(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SayHi", reflect.TypeOf((*MockGreeterService)(nil).SayHi), ctx, req)
}
