...
// RegisterBookstoreService registers service.
...
type UnimplementedBookstore struct{}

// ListShelves 获取所有的书柜
func (s *UnimplementedBookstore) ListShelves(ctx context.Context, req *emptypb.Empty) (*ListShelvesResponse, error) {
	return nil, errors.New("rpc ListShelves of service Bookstore is not implemented")
}

// CreateShelf 创建一个书柜
func (s *UnimplementedBookstore) CreateShelf(ctx context.Context, req *CreateShelfRequest) (*Shelf, error) {
	return nil, errors.New("rpc CreateShelf of service Bookstore is not implemented")
}

// GetShelf 获取一个书柜
func (s *UnimplementedBookstore) GetShelf(ctx context.Context, req *GetShelfRequest) (*Shelf, error) {
	return nil, errors.New("rpc GetShelf of service Bookstore is not implemented")
}

// DeleteShelf 删除一个书柜
func (s *UnimplementedBookstore) DeleteShelf(ctx context.Context, req *DeleteShelfRequest) (*emptypb.Empty, error) {
	return nil, errors.New("rpc DeleteShelf of service Bookstore is not implemented")
}

// ListBooks 获取所有的书
func (s *UnimplementedBookstore) ListBooks(ctx context.Context, req *ListBooksRequest) (*ListBooksResponse, error) {
	return nil, errors.New("rpc ListBooks of service Bookstore is not implemented")
}

// CreateBook 创建一本书
func (s *UnimplementedBookstore) CreateBook(ctx context.Context, req *CreateBookRequest) (*Book, error) {
	return nil, errors.New("rpc CreateBook of service Bookstore is not implemented")
}

// GetBook 获取一本书
func (s *UnimplementedBookstore) GetBook(ctx context.Context, req *GetBookRequest) (*Book, error) {
	return nil, errors.New("rpc GetBook of service Bookstore is not implemented")
}

// DeleteBook 删除一本书
func (s *UnimplementedBookstore) DeleteBook(ctx context.Context, req *DeleteBookRequest) (*emptypb.Empty, error) {
	return nil, errors.New("rpc DeleteBook of service Bookstore is not implemented")
}

// UpdateBook 更新一本书
func (s *UnimplementedBookstore) UpdateBook(ctx context.Context, req *UpdateBookRequest) (*Book, error) {
	return nil, errors.New("rpc UpdateBook of service Bookstore is not implemented")
}
func (s *UnimplementedBookstore) UpdateBooks(ctx context.Context, req *UpdateBooksRequest) (*ListBooksResponse, error) {
	return nil, errors.New("rpc UpdateBooks of service Bookstore is not implemented")
}
...
type BookstoreClientProxy interface {
	// ListShelves 获取所有的书柜
	ListShelves(ctx context.Context, req *emptypb.Empty, opts ...client.Option) (rsp *ListShelvesResponse, err error)
	// CreateShelf 创建一个书柜
	CreateShelf(ctx context.Context, req *CreateShelfRequest, opts ...client.Option) (rsp *Shelf, err error)
	// GetShelf 获取一个书柜
	GetShelf(ctx context.Context, req *GetShelfRequest, opts ...client.Option) (rsp *Shelf, err error)
	// DeleteShelf 删除一个书柜
	DeleteShelf(ctx context.Context, req *DeleteShelfRequest, opts ...client.Option) (rsp *emptypb.Empty, err error)
	// ListBooks 获取所有的书
	ListBooks(ctx context.Context, req *ListBooksRequest, opts ...client.Option) (rsp *ListBooksResponse, err error)
	// CreateBook 创建一本书
	CreateBook(ctx context.Context, req *CreateBookRequest, opts ...client.Option) (rsp *Book, err error)
	// GetBook 获取一本书
	GetBook(ctx context.Context, req *GetBookRequest, opts ...client.Option) (rsp *Book, err error)
	// DeleteBook 删除一本书
	DeleteBook(ctx context.Context, req *DeleteBookRequest, opts ...client.Option) (rsp *emptypb.Empty, err error)
	// UpdateBook 更新一本书
